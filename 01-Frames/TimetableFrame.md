...
| Attribute | version |  |  | 
| Attribute | id |  |  | 
| List | vehicleJourneys | [ServiceJourney](/10-Objects/ServiceJourney.md) | A passenger carrying VEHICLE JOURNEY for one specified DAY TYPE. The pattern of working is in principle defined by a SERVICE JOURNEY PATTERN.

The VIEW includes derived ancillary data from referenced entities. | 
| List | vehicleJourneys | [DatedServiceJourney](/10-Objects/DatedServiceJourney.md) | A particular journey of a vehicle on a particular OPERATING DAY including all modifications possibly decided by the control staff. 
